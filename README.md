...
- 背景：近几年来减肥热充斥着我们的日常生活，人们为了追求更完美的身材逐渐开始关注运动健身，但是不少人刚开始健身时没有完全了解自己的身体状况，盲目的运动健身导致付出了时间但收效甚差。针对这一现象我们想推出一款智能运动app叫“懂你所动”。
产品介绍：“懂你所动”app是一款智能运动app，它可以根据用户的身形体态推荐相应的运动健身教程视频，用户通过上传自己的全身照后，app可以分析出用户的体型，进而推荐相对应的运动视频，就比如一名用户上传了自己的图片，app分析出她腿部肌肉较为发达，那么它会根据用户的身材特征而去筛选推荐一些有关瘦腿的运动教程给用户，在开始运动后app会持续打开拍摄功能跟进用户的运动轨迹，动作角度等，进而去分析这一运动视频是否符合用户身体状况，然后分析出后续的推荐中是否需要增加难度或者降低难度，真正的去做到懂得的用户。
目标用户：体型肥胖者，运动健身者，塑型减肥者，运动小白
所用到的api技术：百度API中的人体关键点分析（根据人体关键点信息，分析人体姿态、运动轨迹、动作角度等）和人体检测与属性识别（识别人体的性别年龄等）的API功能
以上是这款产品的初步想法谢谢。
...
[API人体关键点识别代码尝试](https://github.com/chanvi-yunqing/API_ML_AI-sports/blob/master/API%E4%BD%BF%E7%94%A8%E6%B0%B4%E5%B9%B3%E6%B5%8B%E8%AF%952.md)
...
#### 人体检测与属性识别（输入与输出）
[API人体检测与属性识别代码尝试](https://github.com/chanvi-yunqing/API_ML_AI-sports/blob/master/API%E4%BD%BF%E7%94%A8%E6%B0%B4%E5%B9%B3.md)
